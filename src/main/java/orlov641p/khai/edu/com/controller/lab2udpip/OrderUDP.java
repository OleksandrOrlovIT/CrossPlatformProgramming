...
public class OrderUDP extends JFrame {
    ...
    private void sendRequest(DatagramSocket socket, InetAddress serverAddress, int serverPort, String request) {
        try {
            consoleTextArea.setText(ORDER_REQUEST + " " + request + "\n");
            request = ORDER_REQUEST + "," + request;
    ...
    private void getById() {
        ...
        sendRequest(socket, serverAddress, serverPort, "GET_BY_ID," + orderId);
    }
    ...
    private void deleteById() {
        ...
        sendRequest(socket, serverAddress, serverPort, "DELETE_BY_ID," + orderId);
    }

    public static void main(String[] args) {
        SwingUtilities.invokeLater(OrderUDP::new);
    }
}